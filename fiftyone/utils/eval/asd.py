...
class AsdEvaluationConfig(KeypointEvaluationConfig):
    def __init__(
        self,
        pred_field,
        gt_field,
...
class AsdEvaluation(KeypointEvaluation):
...
class AsdDetectionResults(KeypointResults):
